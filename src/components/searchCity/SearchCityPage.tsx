...
import { WeatherInfo, WeatherCtx, SearchCityProps } from "../../Types/Types";

export default function SearchCityPage({ route, navigation }: SearchCityProps) {
  ...
  return (
    <WeatherCtx.Provider value={sampleWeatherContext}>
      <SearchCityItem navigation={navigation} route={route} />
    </WeatherCtx.Provider>
  );
}
